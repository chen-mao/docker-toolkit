...
import (
	...
	createdefault "github.com/XDXCT/xdxct-container-toolkit/cmd/xdxct-ctk/config/create-default"
...
func (m command) build() *cli.Command {
	...
	c := cli.Command{
		Name:  "config",
		Usage: "Interact with the XDXCT Container Toolkit configuration",
