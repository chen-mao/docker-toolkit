// WARNING: This file has automatically been generated on Thu, 04 Jan 2024 14:50:32 CST.
...
const (
	// MAX_DEVICES as defined in xdxml/xdxml.h:12
	MAX_DEVICES = 2
	// PARAMETER_PAGE_OFFSET as defined in xdxml/xdxml.h:14
	PARAMETER_PAGE_OFFSET = 0x58000
	// FW_GLOABL_STRUCT_OFFSET as defined in xdxml/xdxml.h:15
	FW_GLOABL_STRUCT_OFFSET = 0x59000
	// CMCU_VARS_OFFSET as defined in xdxml/xdxml.h:16
	CMCU_VARS_OFFSET = 0x6FF000
	// DEVICE_NAME_BUFFER_SIZE as defined in xdxml/xdxml.h:21
	DEVICE_NAME_BUFFER_SIZE = 64
	// XDXGPU_INFO_UTIL_INFO as defined in xdxml/xdxml.h:33
	XDXGPU_INFO_UTIL_INFO = 0x02
	// RGXFWIF_DM_MAX as defined in xdxml/xdxml.h:34
	RGXFWIF_DM_MAX = (uint32(9))
	// RGX_NUM_OS_SUPPORTED as defined in xdxml/xdxml.h:35
	RGX_NUM_OS_SUPPORTED = 1
	// DEVICE_PCI_BUS_ID_BUFFER_SIZE as defined in xdxml/xdxml.h:41
	DEVICE_PCI_BUS_ID_BUFFER_SIZE = 32
	// RET_SIZE as defined in xdxml/xdxml.h:47
	RET_SIZE = 1000000
	// MAX_PATH_LEN as defined in xdxml/xdxml.h:48
	MAX_PATH_LEN = 100
	// PROCESS_NAME_LEN as defined in xdxml/xdxml.h:49
	PROCESS_NAME_LEN = 30
)

// Return as declared in xdxml/xdxml.h:82
type Return int32

// Return enumeration from xdxml/xdxml.h:82
const (
	ERROR                         Return = -1
	SUCCESS                       Return = 0
