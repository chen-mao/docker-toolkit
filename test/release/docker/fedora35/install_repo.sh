...
sed -i -e "s#nvidia\.github\.io/libxdxct-container#${test_repo}/libxdxct-container#g" /etc/yum.repos.d/nvidia-container-toolkit.repo
yum-config-manager --enable libxdxct-container-experimental
